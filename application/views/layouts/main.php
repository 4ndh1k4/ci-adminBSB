        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php if(isset($usr)){echo $usr->first_name;}?></div>
                    <div class="email"><?php if(isset($usr)){echo $usr->email;}?></div>
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="seperator" class="divider"></li>
                            <li><?php echo anchor('auth/logout','<i class="material-icons">input</i>Sign Out</a>');?></li>
                        </ul>
                    </div>
                </div>
            </div>
