                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">							
							...
							<div class="form-group form-float">
								<div class="form-line">									
									<?php echo form_input($company);?><?php echo lang('edit_user_company_label', 'company','class="form-label"');?> 
								</div>
							</div>
 						    <div class="form-group form-float">
								<div class="form-line">									
									<?php echo form_input($phone);?><?php echo lang('edit_user_phone_label', 'phone','class="form-label"');?> 
								</div>
							</div>
							<div class="form-group form-float">
								<div class="form-line">									
							...
							<div class="form-group form-float">
								...
								<?php echo anchor('auth/index','Kembali','class="btn btn-warning waves-effect"');?>
							</div>
